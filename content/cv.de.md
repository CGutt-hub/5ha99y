...
[PDF-Version herunterladen →](#) *(Demnächst verfügbar)*
...
- Entwicklung einer maßgeschneiderten Python-Toolbox für robuste Verarbeitung, Merkmalsextraktion und statistische Analyse multimodaler physiologischer Daten (EEG, fNIRS, EKG)
...
Fokussiertes akademisches Studium in Systemneurologie, Bewusstseinsforschung und Prinzipien verkörperter Kognition und neural-autonomer Integration

**Robotik & Künstliche Intelligenz**  
Grundlagenwissen in Robotik und KI-Konzepten aus spezialisierten Masterkursen

**Physiologische Signalverarbeitung**  
Python (NumPy, SciPy, MNE, Statsmodels) für Verarbeitung und Analyse multimodaler physiologischer Datenströme (EEG, fNIRS, EKG)

**Wissenschaftliche Softwareentwicklung**  
Maßgeschneiderte Python-Toolboxen für Automatisierung von Analysepipelines, Merkmalsextraktion und statistische Modellierung

**Humanorientierte Forschungsmethoden**  
Design und Durchführung von Experimenten mit menschlichen Probanden, einschließlich Datenerfassung und ethischer Compliance (Ethikkommission, DSGVO)

**Biochemische & Nasslabor-Techniken**  
Molekularbiologie und nasschemische Analyse aus formaler Ausbildung und Bachelorstudium
...
Python (NumPy, SciPy, Pandas, MNE, NeuroKit2, Statsmodels) · MATLAB (EEGLAB) · LaTeX · R · C#

**Physiologische Methoden**  
Datenerfassung & -analyse für EEG, fNIRS, EKG, PPG, EDA und fMRT (FSL)

**Betriebssysteme**  
Versiert mit Windows- und Linux-Umgebungen

**Laborkenntnisse**  
Biochemische & molekularbiologische Techniken · Nasschemische Analyse · Laborsicherheit & Protokolle
...
### Masterarbeit
**Neural-Autonome Synchronie und Verkörperte Integration**  
M.Sc. Kognitionswissenschaft, Ruhr-Universität Bochum (2024)
...
Ich bin der **offenen und transparenten Wissenschaft** verpflichtet und glaube, dass die tiefgreifendsten Fortschritte aus kollaborativen, interdisziplinären Ansätzen entstehen. Mein Hintergrund, der von Molekularbiologie bis Kognitionswissenschaft reicht, hat mir eine multiskalare Perspektive auf komplexe Probleme vermittelt und betont den Wert der Integration von Erkenntnissen über verschiedene Analyseebenen und Studienfelder hinweg.
...
**Musik** — Amateur-Multiinstrumentalist mit Klavierausbildung und Erfahrung mit Gitarre, Mundharmonika, Schlagzeug und Volksinstrumenten
